...
paths = '/root/vol1/da_capstone/pytorch-nested-unet-master/models/Figshare*/log.csv'
paths = glob(paths)


model_list = pd.DataFrame(read_csv(paths[0])) # 0 1 2
...
plt.suptitle("  UNet++(deepsupervision)  lr = 0.005", fontsize = 20)    # UNet++(deepsupervision)  UNet++   UNet
plt.tight_layout()
plt.savefig("/root/vol1/da_capstone/pytorch-nested-unet-master/outputs/savefig_NestedUNet_deepsupervision(0.005,100).png")
#  savefig_NestedUNet_deepsupervision        savefig_NestedUNet         savefig_UNet